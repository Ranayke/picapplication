...
export class AlertService {
    ...
    alertSucject: Subject<Alert | null> = new Subject<Alert | null>();
    ...
    private alert(alertType: AlertType, message: string, keepAfterRouteChange: boolean) {
        ...
        this.alertSucject.next(new Alert(alertType, message))
    }

    getAlert() {
        return this.alertSucject.asObservable();
    }

    clear() {
        this.alertSucject.next(null);
    }
